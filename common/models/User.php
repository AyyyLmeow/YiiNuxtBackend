 ...
 * @property UserRefreshTokens $userRefreshToken
 */
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function setPassword($password)
    {
        ...
        if($oldPass != $this->password_hash || !isset($oldPass)) {
    ...
    {
        return $this->hasOne(UserRefreshTokens::className(),['urf_userID' => 'id']);
    }

    public function fields(): array
    {
        return['id','username','auth_key','password_hash','password_reset_token','email','status','created_at','updated_at','verification_token','userInfo'];
    }
    ...
    public function hashOnlyPassAndSave($model)
    {
